...
# not copyable and such uses don't compile...) On a second thought,
# this may work correctly despite the warning: passing a struct may be
# the same as the pointer if the struct contains just it.
